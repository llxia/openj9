...
ifndef NATIVE_TEST_LIBS
	NATIVE_TEST_LIBS=$(Q)$(JDK_HOME)$(D)..$(D)native-test-libs$(Q)
endif

JAVA_LIB_PATH_OPT=-Djava.library.path=$(NATIVE_TEST_LIBS)

ifneq (,$(findstring win,$(SPEC)))
	JAVA_SHARED_LIBRARIES_DIR:=$(JAVA_BIN)$(D)$(VM_SUBDIR)$(P)$(NATIVE_TEST_LIBS)
else
	JAVA_SHARED_LIBRARIES_DIR:=$(JAVA_LIB_DIR)$(D)$(ARCH_DIR)$(D)$(VM_SUBDIR)$(P)$(NATIVE_TEST_LIBS)
endif
